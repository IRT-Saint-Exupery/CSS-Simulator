...
#define CF_EXTERNAL_CFDP
#include "/home/nos3/Desktop/github-nos3/fsw/apps/io_lib/fsw/public_inc/trans_udp.h" //IRT CSS
#include "/home/nos3/Desktop/github-nos3/fsw/apps/io_lib/fsw/public_inc/trans_select.h"

/* Device task even IDs */ //IRT CSS
#define CF_TASK_REG_ERR_EID          60
#define CF_TASK_REG_INF_EID          61
#define CF_TASK_CREATE_EID           61

#define CF_CFG_SPP_RCV_PORT        3642   

/*
** CF Task Definitions
*/
#define CF_DEVICE_NAME              "CF_CHILD_TASK"
#define CF_DEVICE_STACK_SIZE        2048
#define CF_DEVICE_PRIORITY          110  
#define CF_CUSTOM_CLTU_BUFF_SIZE    2000
...
typedef struct
{
    ...
    IO_TransSelect_t  rcv_selector; // IRT CSS
    IO_TransUdp_t SPP_Rcv; //IRT CSS
    uint32 DeviceID;		            /* Device ID provided by CFS on initialization */ //IRT CSS
