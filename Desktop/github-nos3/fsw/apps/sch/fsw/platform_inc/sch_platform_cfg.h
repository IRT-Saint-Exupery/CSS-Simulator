...
*/
#define SCH_TOTAL_SLOTS         100    /* SCH wake-up rate (Hz) 100 by default */
...
*/
#define SCH_ENTRIES_PER_SLOT    5 /* default is 5*/
...
**       Must be at least one
*/
#define SCH_MAX_SLOTS_PER_WAKEUP      5  /* default is 5*/
...
**       Must be greater than zero
*/
#define SCH_MICROS_PER_MAJOR_FRAME    1000000  /*default is 1000000*/
...
**       None
*/
#define SCH_STARTUP_SYNC_TIMEOUT   50000  /*default is 50000 */
