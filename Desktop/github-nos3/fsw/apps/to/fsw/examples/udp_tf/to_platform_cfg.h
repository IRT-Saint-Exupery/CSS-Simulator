...
#define TO_SCH_PIPE_DEPTH  10   // 10 IRT CSS
#define TO_CMD_PIPE_DEPTH  10   // 10 IRT CSS
#define TO_TLM_PIPE_DEPTH  20   // default = 10 // IRT CSS

#define TO_NUM_CRITICAL_MIDS   3

#define TO_MAX_TBL_ENTRIES    100
#define TO_WAKEUP_TIMEOUT     50  // 50 or 100 IRT CSS
...
#define TO_CUSTOM_TF_SIZE   1436  //1536 // IRT CSS // max should be < 1468 to be able to redirect.
...
//#define TO_CUSTOM_TF_SCID       0 //TODO unused
#define TO_CUSTOM_TF_ERR_CTRL   1 // IRT CSS
