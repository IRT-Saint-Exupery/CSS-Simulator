...
cmdUtil --port=5011 --endian=LE --pktid=0x1804 --cmdcode=2 --string="64:/cf/apps/to_config_2.tbl"
sleep 1
# Verify the new inactive table
echo "Step 2: Verify the new table through CFE_TBL."
cmdUtil --port=5011 --endian=LE --pktid=0x1804 --cmdcode=4 --half=0 --string="40:TO.to_config"
sleep 1
# Activate the new table (CFE TBL will call TO_ManageTable
echo "Step 3: Activate the new table through CFE_TBL."
cmdUtil --port=5011 --endian=LE --pktid=0x1804 --cmdcode=5 --string="40:TO.to_config"
sleep 1
