...
/*{  SCH_DISABLED, SCH_ACTIVITY_SEND_MSG,  1,  0, 24, SCH_GROUP_MD_WAKEUP }, */  /* MD Wakeup */
  //IRT CSS - Frequency switched from 5 to 1
...
/*{  SCH_DISABLED, SCH_ACTIVITY_SEND_MSG,  1,  0, 24, SCH_GROUP_MD_WAKEUP }, */  /* MD Wakeup */
  //IRT CSS
  {  SCH_ENABLED,  SCH_ACTIVITY_SEND_MSG,  5,  0, 55, SCH_GROUP_CFE_HK },   /* ISL HK Request */
  {  SCH_ENABLED,  SCH_ACTIVITY_SEND_MSG,  2,  1, 56, SCH_GROUP_CFE_HK },   /* ISL WD Request */
  /*{  SCH_ENABLED,  SCH_ACTIVITY_SEND_MSG,  1,  0, 56, SCH_GROUP_CFE_HK },*/   /* Sample Data Request */
  /*{  SCH_UNUSED,   0,      0,  0, 0,  SCH_GROUP_NONE}, */                                       
  /*{  SCH_UNUSED,   0,      0,  0, 0,  SCH_GROUP_NONE},*/
 /*{  SCH_ENABLED,  SCH_ACTIVITY_SEND_MSG,  1,  0, 57, SCH_GROUP_CFE_HK },*/   /* SYN_APP Data Request */ //LOUIS IRT CSS FIX
  {  SCH_ENABLED,  SCH_ACTIVITY_SEND_MSG,  1,  0, 57, SCH_GROUP_CFE_HK },   /* IDS HK Request */

  {  SCH_UNUSED,   0,      0,  0, 0,  SCH_GROUP_NONE},                                        
  {  SCH_UNUSED,   0,      0,  0, 0,  SCH_GROUP_NONE},                                        

  /* slot #36 */
  /*{  SCH_ENABLED, SCH_ACTIVITY_SEND_MSG,  1,  0, 23, SCH_GROUP_CFS_HK },*/  /* DS Wakeup */ //LOUIS IRT CSS FIX
  {  SCH_UNUSED,   0,      0,  0, 0,  SCH_GROUP_NONE},
...
/*{  SCH_DISABLED, SCH_ACTIVITY_SEND_MSG,  1,  0, 24, SCH_GROUP_MD_WAKEUP }, */  /* MD Wakeup */
  ...
  //IRT CSS - Commented Data because already called in 72 & 82
/*{  SCH_DISABLED, SCH_ACTIVITY_SEND_MSG,  1,  0, 24, SCH_GROUP_MD_WAKEUP }, */  /* MD Wakeup */
