...
/*{ { CFE_MAKE_BIG16(MD_WAKEUP_MID),            CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000 } }, */
  ...
  */
  ...
  { { CFE_MAKE_BIG16(NOVATEL_OEM615_REQ_HK_MID),  CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), CFE_MAKE_BIG16(0x0000) } },
    /* command ID #51 - GPS Data */
  { { CFE_MAKE_BIG16(NOVATEL_OEM615_REQ_HK_MID),  CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), CFE_MAKE_BIG16(0x0100) } },
    /* command ID #52 */
  { { CFE_MAKE_BIG16(SCH_UNUSED_MID) } },
    /* command ID #53 */
  { { CFE_MAKE_BIG16(SCH_UNUSED_MID) } },
    /* command ID #54 */
  { { CFE_MAKE_BIG16(SCH_UNUSED_MID) } },  
    /* command ID #55 - ISL HK */
  { { CFE_MAKE_BIG16(ISL_REQ_HK_MID),  CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), CFE_MAKE_BIG16(0x0000) } },
    /* command ID #56 - ISL Watchdog */
  { { CFE_MAKE_BIG16(ISL_REQ_WD_MID),  CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), CFE_MAKE_BIG16(0x0000) } },
  #ifdef IDS_TELEM_ENABLED
  /* command ID #57 - IDS HK */
  { { CFE_MAKE_BIG16(IDS_REQ_HK_MID),  CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), CFE_MAKE_BIG16(0x0000) } },
  #else
    /* command ID #57 */
  { { CFE_MAKE_BIG16(SCH_UNUSED_MID) } },
  #endif
