...
.rts = {
        ...
        /* 1 - ISL Configuration 123 */
        .hdr3.TimeTag = 1,
        .cmd3.CmdHeader = CFE_MSG_CMD_HDR_INIT(ISL_CMD_MID, SC_MEMBER_SIZE(cmd3), ISL_CONFIG_CC, 0x00),
        .cmd3.DeviceCfg = CFE_MAKE_BIG32(123),
    }
};
