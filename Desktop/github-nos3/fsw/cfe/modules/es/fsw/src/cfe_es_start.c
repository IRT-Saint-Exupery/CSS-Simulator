...
struct P1_struct P1_data;
struct P1_struct * P1_struct_ptr = &P1_data;
#endif
#ifdef IDS_P2_ENABLED
struct P2_struct P2_data;
struct P2_struct * P2_struct_ptr = &P2_data;
#endif

#if (defined IDS_P1_ENABLED || defined IDS_P2_ENABLED || defined IDS_P3_ENABLED) && defined IDS_TELEM_ENABLED
struct DetectionReporting DetectionAlert;

IDS_AppData_t IDS_AppData;
#endif

#if defined LOGGING_P1_ENABLED || defined LOGGING_P2_ENABLED || defined LOGGING_P3_ENABLED
unsigned long sim_start_time;
#endif

/*
#ifdef IDS_P3_ENABLED
struct P3_struct P3_data;
struct P3_struct * P3_struct_ptr = &P3_data;
#endif
*/
...
{
    //IRT CSS
    #if defined LOGGING_P3_ENABLED
    struct timespec realtime;
    timespec_get(&realtime, TIME_UTC);
    sim_start_time = realtime.tv_sec;
    #endif

    #if (defined IDS_P1_ENABLED || defined IDS_P2_ENABLED || defined IDS_P3_ENABLED) && defined IDS_TELEM_ENABLED
    sem_init(&(DetectionAlert.is_reporting), 0, 1);
    sem_init(&(DetectionAlert.sem_detect_count), 0, 1);
    if (pipe(DetectionAlert.pipe_alert)<0)
    {
    	printf("alert pipe failed\n");
    }
    fcntl(DetectionAlert.pipe_alert[0], F_SETFL, fcntl(DetectionAlert.pipe_alert[0], F_GETFL) | O_NONBLOCK);
    #endif
    
    #if defined IDS_P1_ENABLED && defined IDS_P2_ENABLED
    sem_init(&(P1_data.cfdp_sem), 0, 1);
    #endif
