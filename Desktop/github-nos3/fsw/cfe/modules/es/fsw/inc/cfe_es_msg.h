...
/**
 * \brief Generic application critical TC name command
 */

typedef struct CFE_ES_StopAppCmd   // IRT CSS
{
    CFE_MSG_CommandHeader_t     CommandHeader; 		/**< \brief Command header */
    CFE_ES_AppNameCmd_Payload_t Payload;       		/**< \brief Command payload */
    char                        MAC[CFE_CRITICAL_TC_MAC_LEN];  /**< \brief MAC for critical command */
} CFE_ES_StopAppCmd_t;
 ...
 */
//typedef CFE_ES_AppNameCmd_t CFE_ES_StopAppCmd_t; //IRT CSS
