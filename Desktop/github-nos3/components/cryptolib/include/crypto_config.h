...
// Spacecraft Defines
//#define SCID 0x0002 //44 //0x0003 // 0xC3D2
#define SCID g_satId

extern unsigned int g_satId;
...
#define KEY_SIZE 32 /* bytes */ //IRT CSS
//#define KEY_ID_SIZE 8
#define KEY_ID_SIZE 2 //IRT CSS
#define NUM_KEYS 256
#define DISABLED 0
#define ENABLED 1
//#define IV_SIZE 16   /* TM IV size bytes */
#define IV_SIZE 12   /* TM IV size bytes */ //IRT CSS
//#define IV_SIZE_TC 4 /* TC IV size bytes */
#define IV_SIZE_TC 12 /* TC IV size bytes */ //IRT CSS
#define OCF_SIZE 4
