...
#define NB_SATELLITES 7
  //						    		0	1	2	3	4	5	6	7
  unsigned int TC_APPLY_PORTS[NB_SATELLITES + 1] = 	       {-1,	6010,	6012,	6014,	6016,	6018,	6020,	6022};	// Receive TC
 unsigned int TC_APPLY_FWD_PORTS[NB_SATELLITES + 1] =  	{-1,	8010,	8010,	8010,	8010,	8010,	8010,	8010};  
  unsigned int TM_PROCESS_PORTS[NB_SATELLITES + 1] = 	       {-1,	8011,	8013,	8015,	8017,	8019,	8021,	8023};	// Receive TM
 unsigned int TM_PROCESS_FWD_PORTS[NB_SATELLITES + 1] =        {-1,	6011,	6013,	6015,	6017,	6019,	6021,	6023};
  
#define TC_APPLY_PORT   	TC_APPLY_PORTS[satId]
#define TC_APPLY_FWD_PORT	TC_APPLY_FWD_PORTS[satId]
#define TM_PROCESS_PORT	TM_PROCESS_PORTS[satId]
#define TM_PROCESS_FWD_PORT	TM_PROCESS_FWD_PORTS[satId]

#define CRYPTO_STANDALONE_TC_APPLY_DEBUG
//#define CRYPTO_STANDALONE_TM_PROCESS_DEBUG

#define CRYPTO_STANDALONE_HANDLE_FRAMING
#define CRYPTO_STANDALONE_FRAMING_SCID satId
