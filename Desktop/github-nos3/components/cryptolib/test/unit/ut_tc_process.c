...
UTEST(TC_PROCESS, GCM_IV_AND_ARSN)
{
    ...
    char* buffer_replay_h = "2003002500FF0009B6AC8E4963F49207FFD6374B1224DFEFB72A20D49E09256908874979DFC1"; // IV is one less than library expects
    char* buffer_outside_window_h = "2003002500FF0009B6AC8E4963F49207FFD6375C1224DFEFB72A20D49E09256908874979B36E"; // IV is outside the positive window
    char* buffer_bad_iv_bad_arsn_h = "2003002500FF0009B6AC8E4963F49207FFD6374C01231224DFEFB72A20D49E09256908874979"; // IV isa replay, ARSN is a replay
    char* buffer_good_iv_bad_arsn_h = "2003002500FF0009B6AC8E4963F49207FFD6374C01231224DFEFB72A20D49E09256908874979"; // IV is the next one expected, ARSN is a replay
    char* buffer_bad_iv_good_arsn_h = "2003002500FF0009B6AC8E4963F49207FFD6374B01241224DFEFB72A20D49E09256908874979"; // IV is a replay, ARSN is next expected
    char* buffer_good_iv_with_gap_h = "2003002500FF0009B6AC8E4963F49207FFD6374F1224DFEFB72A20D49E092569088749799C49"; // IV is valid, but not next one expected
    char* buffer_high_iv_good_arsn_h = "2003002500FF0009B6AC8E4963F49207FFD6374B01241224DFEFB72A20D49E09256908874979"; // IV is outside upper bounds, ARSN is next expected
    char* buffer_good_iv_high_arsn_h = "2003002500FF0009B6AC8E4963F49207FFD6374BFFFE1224DFEFB72A20D49E09256908874979"; // IV is next expected, ARSN is outside upper bounds
    ...
    hex_conversion(buffer_good_iv_gap_good_arsn_gap_h, (char**) &buffer_good_iv_gap_good_arsn_gap_b, &buffer_good_iv_gap_good_arsn_gap_len);
    // Convert/Set input IV
    hex_conversion(buffer_nist_iv_h, (char**) &buffer_nist_iv_b, &buffer_nist_iv_len);
    memcpy(test_association->iv, buffer_nist_iv_b, buffer_nist_iv_len);
    // Convert/Set input ARSN
    ...
    printf(KGRN "Checking replay - using previous received ARSN...\n" RESET);
    status = Crypto_TC_ProcessSecurity(buffer_good_iv_bad_arsn_b, &buffer_good_iv_bad_arsn_len, tc_nist_processed_frame);
    ASSERT_EQ(CRYPTO_LIB_ERR_ARSN_OUTSIDE_WINDOW, status);
    ...
    printf(KGRN "Checking replay - using previous received IV...\n" RESET);
    status = Crypto_TC_ProcessSecurity(buffer_bad_iv_good_arsn_b, &buffer_bad_iv_good_arsn_len, tc_nist_processed_frame);
    ASSERT_EQ(CRYPTO_LIB_ERR_IV_OUTSIDE_WINDOW, status);
    ...
    status = Crypto_TC_ProcessSecurity(buffer_good_iv_good_arsn_b, &buffer_good_iv_good_arsn_len, tc_nist_processed_frame);
    ASSERT_EQ(CRYPTO_LIB_SUCCESS, status);
