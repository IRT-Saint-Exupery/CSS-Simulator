...
void reload_db(void)
{
    ...
    system("mysql --host=192.168.100.42 -uroot -pitc123! < ../../src/sa/sa_mariadb_sql/empty_sadb.sql");
    system("mysql --host=192.168.100.42 -uroot -pitc123! < ../../src/sa/test_sa_mariadb_sql/create_sa_ivv_unit_tests.sql");
}
...
char* mysql_hostname = "192.168.100.42";
