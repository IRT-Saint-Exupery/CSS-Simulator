...
void Crypto_Init_SetScId(unsigned int scId) 
{
	g_satId = scId;
}
...
int32_t Crypto_Init_TC_Unit_Test(void)
{
    ...
    // TC Tests
    Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x0001, 0, TC_HAS_FECF, TC_HAS_SEGMENT_HDRS, 1024);
    Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x0001, 1, TC_HAS_FECF, TC_HAS_SEGMENT_HDRS, 1024);
    Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x0001, 4, TC_HAS_FECF, TC_HAS_SEGMENT_HDRS, 1024);
    //IRT CSS
    Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x0001, 11, TC_HAS_FECF, TC_HAS_SEGMENT_HDRS, 1024);
    
    Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x0002, 0, TC_HAS_FECF, TC_HAS_SEGMENT_HDRS, 1024);
    Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x0002, 1, TC_HAS_FECF, TC_HAS_SEGMENT_HDRS, 1024);
    Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x0002, 4, TC_HAS_FECF, TC_HAS_SEGMENT_HDRS, 1024);
    ...
    Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x0004, 0, TC_HAS_FECF, TC_HAS_SEGMENT_HDRS, 1024);
    Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x0004, 1, TC_HAS_FECF, TC_HAS_SEGMENT_HDRS, 1024);
    Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x0004, 4, TC_HAS_FECF, TC_HAS_SEGMENT_HDRS, 1024);
    
    Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x0005, 0, TC_HAS_FECF, TC_HAS_SEGMENT_HDRS, 1024);
    Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x0005, 1, TC_HAS_FECF, TC_HAS_SEGMENT_HDRS, 1024);
    Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x0005, 4, TC_HAS_FECF, TC_HAS_SEGMENT_HDRS, 1024);
    
    Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x0006, 0, TC_HAS_FECF, TC_HAS_SEGMENT_HDRS, 1024);
    Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x0006, 1, TC_HAS_FECF, TC_HAS_SEGMENT_HDRS, 1024);
    Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x0006, 4, TC_HAS_FECF, TC_HAS_SEGMENT_HDRS, 1024);
    
    Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x0007, 0, TC_HAS_FECF, TC_HAS_SEGMENT_HDRS, 1024);
    Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x0007, 1, TC_HAS_FECF, TC_HAS_SEGMENT_HDRS, 1024);
    Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x0007, 4, TC_HAS_FECF, TC_HAS_SEGMENT_HDRS, 1024);
    
    Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x0008, 0, TC_HAS_FECF, TC_HAS_SEGMENT_HDRS, 1024);
    Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x0008, 1, TC_HAS_FECF, TC_HAS_SEGMENT_HDRS, 1024);
    Crypto_Config_Add_Gvcid_Managed_Parameter(0, 0x0008, 4, TC_HAS_FECF, TC_HAS_SEGMENT_HDRS, 1024);
