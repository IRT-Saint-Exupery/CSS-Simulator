#ifndef NOS3_ISLHARDWAREMODEL_HPP
#define NOS3_ISLHARDWAREMODEL_HPP
...
** Defines
*/
#define ISL_SIM_SUCCESS 0
#define ISL_SIM_ERROR   1
...
namespace Nos3
{
    ...
    class IslHardwareModel : public SimIHardwareModel
    {
    public:
        /* Constructor and destructor */
        IslHardwareModel(const boost::property_tree::ptree& config);
        ~IslHardwareModel(void);

    private:
        /* Private helper methods */
        void create_isl_hk(std::vector<uint8_t>& out_data); 
        void create_isl_data(std::vector<uint8_t>& out_data); 
        ...
        SimIDataProvider*                                   _isl_dp; /* Only needed if the sim has a data provider */
