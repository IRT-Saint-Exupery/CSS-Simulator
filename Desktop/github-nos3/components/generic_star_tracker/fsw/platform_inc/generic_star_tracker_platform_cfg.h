...
*/
    ...
    */
    //char* generic_star_tracker_cfg_string[2] = {"/dev/usart_10", "/dev/usart_11"}; //IRT CSS
    //int generic_star_tracker_cfg_handle[2]   = {10, 11};
    ...
    #define GENERIC_STAR_TRACKER_CFG_MS_TIMEOUT       250            /* Max 255 */
