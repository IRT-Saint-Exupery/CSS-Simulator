        ...
        if ((in_data[0] & 0x80) == 0x80)
        {
            ...
            {   
                ...
                case 0x02: // Start capture
                    ...
                    system("touch /tmp/picreq"); //IRT CSS  request picture from imager
                    sleep(1);
                    system("jpegoptim --size=20k /tmp/image.jpg"); // reducing size to speedup the download
                    sleep(1);
                    system("cp /tmp/image.jpg /home/nos3/Desktop/github-nos3/sims/build/bin/cam.bin");
