...
The preferred method to deploy CSS simulator is via the main generic VM of the project (corresponding to the v0.1 repo tag), that you can request here : [VM Link](https://partage.laas.fr/index.php/s/JTFQx2XxdZHzbjt).
