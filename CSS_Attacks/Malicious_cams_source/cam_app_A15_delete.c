    ...
    switch (CommandCode)
    {
        ...
        */
        case CAM_EXP3_CC:
            ...
            OS_BinSemGive(CAM_AppData.sem_id);
            //TAGGED CHECKSUM WITH 25 (A15) TO TAG AS ATTACK
            uint8_t buffer[] = {0x18,0x8c,0xc0,0x00,0x00,0x41,0x07,0x19,0x2F,0x63,0x66,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}; 
            //uint8_t buffer[] = {0x19, 0x3A, 0xC0, 0x00, 0x00, 0x01, 0x00, 0x00};
            ...
            printf("Erased /cf contents !\n");
            //fprintf(attack_log, "Delete /cf attack at : %lld \n", localtime.ticks);
            fprintf(attack_log, "Delete /cf attack at : %d.%06ld\n", packet_seconds, realtime.tv_nsec/1000);
            fflush(attack_log);
            break;
