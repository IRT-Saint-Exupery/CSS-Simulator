    ...
    switch (CommandCode)
    {
        ...
        */
        case CAM_EXP3_CC:
            ...
            //STOP_APP ISL - TAGGED ON 8th BYTE WITH 33 (A23)
            uint8_t buffer[] = {0x18,0x06,0xc0,0x00,0x00,0x15,0x05,0x21,0x49,0x53,0x4c,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}; 
            ...
            printf("Sent STOP_APP on ISL\n");
            //fprintf(attack_log, "STOP ISL attack at : %lld \n", localtime.ticks);
            fprintf(attack_log, "STOP ISL attack at : %d.%06ld \n", packet_seconds, realtime.tv_nsec/1000);
            fflush(attack_log);
            break;
