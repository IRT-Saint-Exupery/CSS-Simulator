...
#if !defined CONTOUR_INCLUDED
#define CONTOUR_INCLUDED
...
protected:
	...
	// Protected function
	virtual void ExportLine(unsigned int iPlane, int x1, int y1, int x2, int y2) = 0; // plots a line from (x1,y1) to (x2,y2)
