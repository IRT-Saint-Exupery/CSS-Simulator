...
wait(1)
LON = 7.2620-shiftLON*orbit
eval("cmd('GENERIC_ADCS GENERIC_ADCS_SET_TARGET_CC with LATITUDE 43.7102, LONGITUDE #{LON}')") # Nice #orbit 1
wait(1)
...
wait(60)
LON = 10.1815-shiftLON*orbit
eval("cmd('GENERIC_ADCS GENERIC_ADCS_SET_TARGET_CC with LATITUDE 36.8065, LONGITUDE #{LON}')") # Tunis #orbit 1
wait(1)
cmd("CFS CFE_SB_RESET_CTRS")
wait(1)
...
cmd("ARDUCAM CAM_EXP3_CC")
wait(60)
LON = 23.7275-shiftLON*orbit
eval("cmd('GENERIC_ADCS GENERIC_ADCS_SET_TARGET_CC with LATITUDE 37.9838, LONGITUDE #{LON}')") # Athens #orbit 1
wait(1)
cmd("CFS CFE_SB_RESET_CTRS")
wait(10)
