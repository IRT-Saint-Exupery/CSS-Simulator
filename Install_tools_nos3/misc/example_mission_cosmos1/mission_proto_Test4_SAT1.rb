...
wait(1)
wait_check_expression("tlm('NOVATEL_OEM615 NOVATEL_OEM615_DATA_TLM ECEF_Z') > 100000", 100000)
LON = 1.4440-shiftLON*orbit
eval("cmd('GENERIC_ADCS GENERIC_ADCS_SET_TARGET_CC with LATITUDE 43.6045, LONGITUDE #{LON}')") # Toulouse #orbit 1
wait(1)
...
wait(60)
LON = 13.3666-shiftLON*orbit
eval("cmd('GENERIC_ADCS GENERIC_ADCS_SET_TARGET_CC with LATITUDE 38.1166, LONGITUDE #{LON}')") # Palermo #orbit 1
wait(1)
cmd("CFS CFE_SB_RESET_CTRS")
wait(1)
...
cmd("ARDUCAM CAM_EXP3_CC")
wait(60)
LON = 31.2333-shiftLON*orbit
eval("cmd('GENERIC_ADCS GENERIC_ADCS_SET_TARGET_CC with LATITUDE 30.0333, LONGITUDE #{LON}')") # Cairo #orbit 1
wait(1)
cmd("CFS CFE_SB_RESET_CTRS")
wait(10)
...
wait(5)
# Switch to SUNSAFE
cmd("GENERIC_ADCS GENERIC_ADCS_SET_MODE_CC with GNC_MODE 'SUNSAFE_MODE', MAC '1234'")
wait(3)
...
cmd("GENERIC_ADCS GENERIC_ADCS_SET_MODE_CC with GNC_MODE 'BDOT_MODE', MAC '1234'")
wait(1000)
cmd("GENERIC_ADCS GENERIC_ADCS_SET_MODE_CC with GNC_MODE 'SUNSAFE_MODE', MAC '1234'")
wait(1000)
cmd("GENERIC_ADCS GENERIC_ADCS_SET_MOMENTUM_MANAGEMENT_CC with GNC_MODE 'OFF'")
wait(1)
cmd("GENERIC_ADCS GENERIC_ADCS_SET_MODE_CC with GNC_MODE 'PASSIVE', MAC '1234'")
wait(1)
